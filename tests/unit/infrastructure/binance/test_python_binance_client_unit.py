...
def test_python_binance_client_with_end_str(mock_client_class):
    ...
    mock_kline = [1672531200000, "100.0", "110.0", "90.0", "105.0", "1000.0", 1672531259999, "105000.0", 50, "500.0", "52500.0", "0"]
    mock_binance_client_instance.get_historical_klines_generator.return_value = [mock_kline]
    ...
    klines = client.get_historical_klines("BTCUSDT", TimeFrame.ONE_MINUTE, start_dt, end_dt)
