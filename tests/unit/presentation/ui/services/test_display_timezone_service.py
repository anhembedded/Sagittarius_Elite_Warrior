...
def test_format_display_datetime_utc() -> None:
    dt = datetime(2026, 8, 17, 4, 30, 0, tzinfo=timezone.utc)
...
def test_format_display_datetime_daylight_saving_time() -> None:
    ...
    summer_dt = datetime(2026, 7, 15, 16, 0, 0, tzinfo=timezone.utc)
    ...
    winter_dt = datetime(2026, 1, 15, 16, 0, 0, tzinfo=timezone.utc)
...
def test_format_display_timestamp() -> None:
    ...
    ts = datetime(2026, 8, 17, 0, 0, 0, tzinfo=timezone.utc).timestamp()
