...
def test_control_card_signals(qapp):
    ...
    def on_load(): nonlocal load_emitted; load_emitted = True
    def on_start(): nonlocal start_emitted; start_emitted = True
    def on_stop(): nonlocal stop_emitted; stop_emitted = True
...
def test_control_card_apply_ui_mode(qapp):
    ...
    matrix = {
        "IDLE": {
            "start_stream_button": True,
            "stop_stream_button": False
        },
        "LIVE": {
            "start_stream_button": False,
            "stop_stream_button": True
        },
        "ERROR": {
            "start_stream_button": True,
            "stop_stream_button": False
