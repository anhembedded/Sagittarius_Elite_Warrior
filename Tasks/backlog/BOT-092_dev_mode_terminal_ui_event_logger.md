...
- Khi chạy với `run-ui.ps1 --dev`:
  ...
  3. Giúp lập trình viên / QA khi gặp bug có thể nhìn ngay chuỗi thao tác (action sequence) để viết regression test theo đúng quy chuẩn dự án (`.claude/rules/code-rule.md`).
