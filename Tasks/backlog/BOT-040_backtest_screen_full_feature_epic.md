...
> `BOT-021` ✅ (Static engine, đã xong) và [`BOT-076`](../in_progress/BOT-076_realtime_backtest_engine.md)
...
| [`BOT-024`](BOT-024_backtest_screen_dynamic_ui.md) | Phase 2 — kế thừa toàn bộ UI trên + replay controls, sau khi [`BOT-076`](../in_progress/BOT-076_realtime_backtest_engine.md) xong (`BOT-023` đã huỷ). |
