...
| **[`BOT-107B`](../completed/BOT-107B_monte_carlo_simulation.md)** | **Mô phỏng Monte Carlo & Đánh giá Nguy cơ Phá sản (Risk of Ruin)** | 🔴 `L` | ✅ **Done (2026-09-24)** — Trade Reshuffling M=1,000–10,000 (bootstrap deferred as a seam), Risk of Ruin 50%/100% tách biệt max-drawdown p95/p99, spaghetti chart + histogram phân phối drawdown. Xem Implementation Notes trong file task. |
