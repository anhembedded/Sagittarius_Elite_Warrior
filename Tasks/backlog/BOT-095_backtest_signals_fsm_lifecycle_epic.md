...
| 🔹 **[BOT-095H](BOT-095H_backtest_action_ownership_and_stale_callback_fencing.md)** | **Quyền sở hữu Action & Chặn Callback Lỗi thời** | **P1 (Async Safety)** | `action_id`/generation, immutable config snapshot và terminal outcome; chặn callback cũ ghi đè run mới. **Bắt buộc trước C/D/G.** |
