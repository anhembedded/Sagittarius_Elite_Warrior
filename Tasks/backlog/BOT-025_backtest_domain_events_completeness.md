...
> Thuộc Epic [BOT-006 — Backtest Engine](BOT-006_backtest_engine_execution.md), Cross-cutting. Phụ thuộc `BOT-021` ✅, [`BOT-076`](BOT-076_realtime_backtest_engine.md) (làm **sau** khi cả 2 đã có code thật để rà soát).
>
