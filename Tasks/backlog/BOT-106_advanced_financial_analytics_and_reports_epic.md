...
| ✅ **[`BOT-106B`](../completed/BOT-106B_mae_mfe_trade_excursion_analysis.md)** | **MAE / MFE Trade Excursion Analysis** | 🟡 `M` | **Xong (22/09).** MAE/MFE tính đúng ở cả Static lẫn Historical Tick Backtest — [`BUG-133`](../bug_report/completed/BUG-133_tick_backtest_never_checks_intrabar_stops.md) ✅ đã đóng cùng ngày. Trình bày (Trade Logs) → [`BOT-106D`](../completed/BOT-106D_present_mae_mfe_drawdown_and_monthly_returns.md) ✅. |
