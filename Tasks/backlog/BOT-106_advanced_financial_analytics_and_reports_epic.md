...
**Trạng thái:** 🟡 **3/3 task con xong phần domain (22/09) — trình bày (UI) chuyển sang [`BOT-106D`](BOT-106D_present_mae_mfe_drawdown_and_monthly_returns.md) (backlog): QML đích (`BackTestTradeLogs.qml`, `MonthlyReturnsHeatmap.qml`, `DrawdownUnderwaterCard.qml`) đã bị gỡ khỏi codebase trước `EPIC-025`, cần PySide6 thật (`ui-presentation-rule.md`)**  
