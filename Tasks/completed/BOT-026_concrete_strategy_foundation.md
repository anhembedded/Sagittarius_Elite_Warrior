...
[BOT-039](../cancelled/BOT-039_dev_board_strategy_toggle_and_markers.md) (P3, làm sau khi
có UI Backtest thật).
...
- [ ] **Dọn `src/domain/indicator_scripts/ema_cross_script.py`** — xoá 2 dòng
  ...
  [BOT-039](../cancelled/BOT-039_dev_board_strategy_toggle_and_markers.md) chạy Strategy
...
- **Không** làm UI/QML/presenter/marker rendering ở task này — toàn bộ phần
  đó thuộc [BOT-039](../cancelled/BOT-039_dev_board_strategy_toggle_and_markers.md).
