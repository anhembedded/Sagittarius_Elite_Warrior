...
| **[EPIC-018](epics/EPIC-018_page_shell_bo_cuc_4_dai/README.md)** | **`PageShell` — bố cục 4 dải dùng chung** — user đối chiếu mockup vs app thật: nút "Mở rộng" Backtest ẩn vĩnh viễn (thiếu 1 signal connection), tiêu đề Dev Board bị cắt (fixed-width), Database rail bên trái sai luật, Backtest/Dev Board thiếu đầu trang riêng. `PageShell` (header/context-bar/workspace+rail-luôn-phải/console) áp cho cả 4 màn | ✅ **Hoàn thành** — 2026-08-30; verify bằng build app thật offscreen + chụp ảnh so sánh |
