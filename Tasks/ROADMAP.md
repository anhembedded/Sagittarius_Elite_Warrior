...
| **[EPIC-012](epics/EPIC-012_hop_dong_tuong_minh_va_tach_coordinator/README.md)** | **Hợp đồng tường minh & tách nốt Coordinator** — hợp đồng Presenter↔View 15 thành viên chưa bao giờ được khai báo; 74 tham số ctor của 6 Coordinator, 24 là accessor state. Luật §2.1 cấm duck-typing ngầm (ABC mặc định, `Protocol` chỉ khi Shiboken chặn), View chọn lúc bootstrap từ config | 🟡 Đang làm (1/7 task con) |
