...
- [x] **`BUG-071`**: [`app_config.json`'s `log.viewer.enabled: true` rò 1 thread TCP nền sống suốt phần còn lại phiên CI đơn-tiến-trình — đổi default về `false`](bug_report/completed/BUG-071_log_viewer_enabled_by_default_leaks_tcp_worker_thread.md)
