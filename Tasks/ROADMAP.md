...
| **1** | **[BOT-056](backlog/BOT-056_backtest_chart_canvas.md)** | **Chart Canvas** | `BOT-022` ✅, `BOT-055` ✅, `BOT-032` ✅ | 3 chế độ: Nến Nhật / Đường Vốn (Equity, có chấm tròn mỗi lệnh) / **Song song (Cả 2)**. Overlays: 4 EMA, Buy/Sell Flags, Volume. QML Badges chờ `BOT-053`. |
