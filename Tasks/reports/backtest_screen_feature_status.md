...
|---|---|---|
| Modal "Cấu hình Thông số Bot" (form động theo schema) | [`BOT-044`](../completed/BOT-044_param_schema_core.md)/[`046`](../backlog/BOT-046_strategy_param_plumbing.md)/[`047`](../backlog/BOT-047_dynamic_params_form_ui.md) | Nút đã có (`btnBacktestBotParams`), đang khoá |
