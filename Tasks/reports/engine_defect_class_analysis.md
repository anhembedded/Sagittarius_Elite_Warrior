...
| :---: | :--- | :--- | :---: | :---: |
| 1 | [`BOT-066`](../backlog/BOT-066_fail_loud_ui_action_errors.md) | `safe_ui_action` báo lỗi thật (log + event + re-raise ở dev mode) | B | Thấp |
| 2 | [`BOT-067`](../backlog/BOT-067_resource_scope_lifecycle.md) | `ResourceScope` — teardown tự động theo vòng đời lần chạy | C | Trung bình |
...
| 5 | [`BOT-070`](../backlog/BOT-070_qml_value_normalizer.md) | `from_qml()` — chuẩn hoá giá trị qua ranh giới QML | E | Rất thấp |
