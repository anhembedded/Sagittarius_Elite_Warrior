...
- **4.4f-5 — the shared core ports + indicator scripts + deletion.** `IEventPublisher`/
  ...
  4.4f-3/4.4f-4 have landed and `grep` confirms nothing else imports it.
