...
| **[EPIC-010](EPIC-010_ghi_nho_gia_tri_cuoi/README.md)** | **Ghi nhớ giá trị cuối** — ~45 giá trị user đặt đang mất sạch mỗi lần mở lại app; chỉ 5 key của màn Settings sống sót. Store riêng `ui_state.json` (không dùng `user_config.json`), slice theo màn, merge khi ghi | ✅ **Hoàn thành (8/8 task con)** — 2026-08-26 |
