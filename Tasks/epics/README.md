...
| **[EPIC-005](EPIC-005_qml_to_qtwidgets_migration/README.md)** | Rút khỏi QML về QtWidgets, **trừ chart** — theo từng màn hình, mỗi bước rollback được | 🟡 Đang làm (1/6 task con xong) — nhánh riêng `epic/EPIC-005-qml-to-qtwidgets` |
| **[EPIC-006](EPIC-006_drop_qml/README.md)** | Bỏ hẳn QML, thuần QtWidgets | 🟡 Đang làm (5/6 task con xong) |
...
| **[EPIC-008](EPIC-008_chuan_hoa_luong_event/README.md)** | **Chuẩn hoá luồng sự kiện** — Shared Kernel + port, `BaseEvent` kế thừa được thật, `EventRegistry` + catalog sinh tự động, 3 Feed thay 48 signal cầu nối | 🔵 Chưa bắt đầu (0/8 task con) |
