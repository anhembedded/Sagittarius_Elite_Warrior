...
| **[EPIC-010](EPIC-010_ghi_nho_gia_tri_cuoi/README.md)** | **Ghi nhớ giá trị cuối** — ~45 giá trị user đặt đang mất sạch mỗi lần mở lại app; chỉ 5 key của màn Settings sống sót. Store riêng `ui_state.json` (không dùng `user_config.json`), slice theo màn, merge khi ghi | 🔵 **Chưa bắt đầu (0/8 task con)** — [thiết kế](EPIC-010_ghi_nho_gia_tri_cuoi/design/DESIGN_2026-08-25_ui_state_persistence.md) chờ duyệt, còn 3 câu hỏi mở |
