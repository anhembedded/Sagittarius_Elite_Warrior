...
| **[EPIC-003](EPIC-003_presenter_and_god_file_decomposition/README.md)** | Phân rã Presenter/File quá tải (Coordinator Pattern, Domain Policy, QML) | 🟡 Đang làm (4/7 xong, 1 huỷ — `003D` hết đối tượng sau `EPIC-006F`; còn `003F`, `003G`) |
