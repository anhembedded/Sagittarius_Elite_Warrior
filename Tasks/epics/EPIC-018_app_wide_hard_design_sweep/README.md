...
**Trạng thái:** 🟡 Đang làm — 3/7 task xong (`018A`, `018B`, `018C`); 3
task rà soát `018D`-`018F` + task tích hợp `018G` đã rà soát xong (finding
đã verify, ghi ở ADR round 2), **việc sửa từng task chưa làm**; 3 việc khác
