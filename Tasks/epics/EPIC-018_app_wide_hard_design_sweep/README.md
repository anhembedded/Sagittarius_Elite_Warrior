...
**Trạng thái:** 🟡 Đang làm — 5/7 task xong (`018A`, `018B`, `018C`,
`018D`, `018E`); task rà soát `018F` + task tích hợp `018G` đã rà soát
xong (finding đã verify, ghi ở ADR round 2), **việc sửa chưa làm**; 3
việc khác
