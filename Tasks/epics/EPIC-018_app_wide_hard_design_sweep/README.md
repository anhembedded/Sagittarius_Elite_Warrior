...
**Trạng thái:** 🟡 Đang làm — 4/7 task xong (`018A`, `018B`, `018C`,
`018D`); 2 task rà soát `018E`-`018F` + task tích hợp `018G` đã rà soát
xong (finding đã verify, ghi ở ADR round 2), **việc sửa từng task chưa
làm**; 3 việc khác
