...
**Trạng thái:** ✅ **Hoàn thành (4/4, 2026-09-02)** — `A`/`B`/`D` xong 24/08, `C` xong 02/09.
...
| **[EPIC-004C](completed/EPIC-004C_document_gate_in_rules.md)** | Ghi nhận cổng mới vào `ci-rule.md`/`code-quality-rule.md`/`ONBOARDING.md` | ✅ Xong (02/09) — `code-rule.md` §4 hết tồn tại (đã tách file từ trước), nội dung đi đúng chỗ đã tách |
