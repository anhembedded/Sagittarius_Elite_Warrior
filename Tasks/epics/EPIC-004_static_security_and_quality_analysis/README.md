...
**Trạng thái:** 🟡 Đang làm — 1/4 xong (22/08): `A` xong. Còn `B`, `C`, `D`.
...
| **[EPIC-004B](incomplete/EPIC-004B_wire_gate_into_ci_local.md)** | Nối rule set (với per-file-ignores đã xác định) vào `ci-local.ps1 -Full` | 🔴 Chưa làm |
...
| **[EPIC-004D](incomplete/EPIC-004D_fix_real_findings_and_rollout.md)** | Sửa ~48 lỗi thật tìm được ở `004A` + lộ trình mở rộng rule set dần (backlog dài hạn) | 🔴 Chưa làm |
