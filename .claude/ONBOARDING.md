...
- **Autonomous review execution:** Launching a reviewer subagent/session is automatically authorized under the active task or epic. Upon invocation, the reviewer must execute immediately and autonomously to completion without pausing or prompting the user for confirmation.
