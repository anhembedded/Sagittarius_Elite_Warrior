...
## 2. Scope Definition & Rule Routing
...
## 3. Incremental Implementation Cycle
- Implement one verifiable step advancing acceptance criteria. Reuse existing patterns and shared framework mechanisms.
