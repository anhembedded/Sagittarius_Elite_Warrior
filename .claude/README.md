...
| `rules/pitfalls/ui.md` | rule | `src/presentation/**/*.py`, `src/modules/*/ui/**/*.py`, `src/support/ui_kit/**/*.py` | Traps that produced broken UI code here — one line each, with the bug id. Loads with every presentation, module UI and ui_kit file. |
