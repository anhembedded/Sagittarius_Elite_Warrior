...
- **UI Icon Assets & Theme-Tinted Rendering:**
  - All iconography MUST be standardized SVG vector files in `src/support/ui_kit/assets/icons/` (Lucide/Feather standards). Never use raw Unicode emoji for UI icons.
