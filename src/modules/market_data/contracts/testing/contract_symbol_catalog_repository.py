...
as what it is (`class TestFakeSymbolCatalogRepository(SymbolCatalogRepositoryContract)`) and can add
...
class SymbolCatalogRepositoryContract:
    ...
    def impl(self) -> ISymbolCatalogRepository:
        raise NotImplementedError(
            "a SymbolCatalogRepositoryContract subclass must provide an `impl` fixture "
