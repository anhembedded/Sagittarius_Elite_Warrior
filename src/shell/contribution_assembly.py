...
Two kinds of contributor exist during the strangler period and this is the one
place that knows both: the five legacy screens the shell still carries
(`legacy_screen_adapter.py`), and the bounded contexts, which contribute panels,
dialogs and probes through `BoundedContextModule.contribute()`.
