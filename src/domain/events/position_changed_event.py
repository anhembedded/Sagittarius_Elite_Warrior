...
class PositionChangedEvent(BaseEvent):
    """
    @brief Domain event fired when `position` (an exchange-reported open
    position) changes — opened, sized up/down, or its unrealized PnL moved
    enough to matter (`EPIC-021E`/`EPIC-021F`).
