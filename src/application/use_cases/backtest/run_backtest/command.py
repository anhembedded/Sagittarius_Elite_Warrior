...
class RunBacktestCommand(BaseModel):
    ...
    limit: int = Field(default=1000, description="Number of historical candles to fetch and simulate")
    replay_speed_ms: int = Field(default=100, description="Delay in milliseconds between emitting each simulated candle")
